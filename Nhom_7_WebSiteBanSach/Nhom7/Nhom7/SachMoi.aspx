<%@ Page Title="" Language="C#" MasterPageFile="~/SitePage.Master" AutoEventWireup="true" CodeBehind="SachMoi.aspx.cs" Inherits="Nhom7.SachMoi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3 style="padding-left: 20px; margin-bottom: 5px">Sách mới tháng 12</h3>
            ...
            <ItemTemplate>
                <a href="ProductDetail.aspx?ID_Sach=<%# Eval("ID_Sach") %>" style="text-decoration: none; color: inherit;">
                    <div class="product">
                        ...
                        <!--<img src='<%# ResolveUrl("~/image/" + Eval("Anh")) %>'  width="200" height="270" alt="Book Image" /> -->
